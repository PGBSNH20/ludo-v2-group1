...
namespace Ludo.Test
{
    public class BoardControllerTests
    {
        ...
        public async Task When_Adding_Bad_Board_Expect_Bad_Request()
        {
            ...
            A.CallTo(() => boardRepo.AddBoard(board.BoardName)).Returns(Task.FromException(new ArgumentException("Bad request")));

            var actionResult = await controller.AddBoard(board.BoardName);
