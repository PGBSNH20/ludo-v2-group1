...
namespace Ludo.API.Data
{
    public class PlayerRepo : IPlayerRepo
    {
        ...
        public async Task<Task> MovePlayer(string gameName, string playerName, int diceNumber) //Todo change to correct token
        {
            ...
            playerToMove[0].OldSquareId = playerToMove[0].SquareID;
